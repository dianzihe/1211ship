...
namespace behaviac
{
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			...
			BEHAVIAC_UNUSED_VAR(childStatus);
			EBTStatus result = BT_SUCCESS;
			behaviac::vector<float> opr = ((Enemy*)pAgent)->m_init_speed;
			int opr_index = ((Enemy*)pAgent)->enemyType;
			((Enemy*)pAgent)->initSpeed = (opr)[opr_index];
			return result;
		}
	};
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
			BEHAVIAC_UNUSED_VAR(childStatus);
			float method_p0 = ((Enemy*)pAgent)->initSpeed;
	...
	protected:
		virtual EBTStatus update_impl(Agent* pAgent, EBTStatus childStatus)
		{
			BEHAVIAC_UNUSED_VAR(pAgent);
			BEHAVIAC_UNUSED_VAR(childStatus);
			float method_p0 = ((Enemy*)pAgent)->randomSpeed;
			((Enemy*)pAgent)->_Execute_Method_<METHOD_TYPE_Enemy_setSpeed, void, float >(method_p0);
			return BT_SUCCESS;
		}
	};
	...
	protected:
		...
		{
			EBTStatus result = BT_SUCCESS;
			behaviac::vector<float> opr2 = ((Enemy*)pAgent)->m_init_speed;
			((Enemy*)pAgent)->initSpeed = opr2;
			return result;
		}
	};
	...
	protected:
		...
		{
			EBTStatus result = BT_SUCCESS;
			float opl_p0 = ((Enemy*)pAgent)->initSpeed;
	...
	protected:
		...
		{
			EBTStatus result = BT_SUCCESS;
			float opl_p0 = ((Enemy*)pAgent)->randomSpeed;
			((Enemy*)pAgent)->_Execute_Method_<METHOD_TYPE_Enemy_setSpeed, void, float >(opl_p0);
			return result;
		}
	};
...
#endif
			// locals
			pBT->AddLocal("Enemy", "int", "frameCount", "0");
			// attachments
			// children
			{
