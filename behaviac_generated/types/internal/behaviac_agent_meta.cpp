...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(2874518913u);
			...
			// PlaneEnemy
			meta = BEHAVIAC_NEW AgentMeta(3140645677u);
			AgentMeta::GetAgentMetas()[1537349109u] = meta;
			meta->RegisterMethod(1290208213u, BEHAVIAC_NEW CAgentMethodVoid_1<Vec2&>(FunctionPointer_PlaneEnemy_applyForce));
			meta->RegisterMethod(2931808794u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_PlaneEnemy_avoid));
			meta->RegisterMethod(282034123u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_PlaneEnemy_boundaries));
			meta->RegisterMethod(1225550733u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_PlaneEnemy_eat));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_PlaneEnemy_LogMessage));
			meta->RegisterMethod(2549788687u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_PlaneEnemy_mate));
			meta->RegisterMethod(195703491u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_PlaneEnemy_randomRotate));
			meta->RegisterMethod(1875061600u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_PlaneEnemy_updatePosition));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
			meta->RegisterMethod(502968959u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorRemove());
			meta->RegisterMethod(2697202729u, BEHAVIAC_NEW CAgentMethodVoid(FunctionPointer_PlaneEnemy_wander));

			AgentMeta::Register<behaviac::Agent>("behaviac::Agent");
			AgentMeta::Register<PlaneEnemy>("PlaneEnemy");
			AgentMeta::Register<ETest>("ETest");
			AgentMeta::Register<Vec2>("Vec2");
		...
		virtual bool unLoad()
		{
			...
			AgentMeta::UnRegister<PlaneEnemy>("PlaneEnemy");
			AgentMeta::UnRegister<ETest>("ETest");
			AgentMeta::UnRegister<Vec2>("Vec2");
